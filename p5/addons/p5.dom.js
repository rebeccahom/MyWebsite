...
(function(root, factory) {
   ...
   * elements created by <a href="#/p5/createCanvas">createCanvas</a> or
   ...
   *  (if step is set to 0, the slider will move continuously from the minimum to the maximum value)
   * @return {p5.Element} pointer to <a href="#/p5.Element">p5.Element</a> holding created node
   * @example
   * <div><code>
   * var slider;
